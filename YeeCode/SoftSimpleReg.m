...
tSim = 200e-15;
f = 460e12; %CHANGED THE FREQUENCY OF EXCITIATION 
lambda = c_c/f;
...
epi{1}(125:150,55:95)= c_eps_0*11.3; %CHANGE HERE Did comment it out for part 2 
epi{1}(80:100,30:40)= c_eps_0*5; %Added new inclusion 
...
bc{1}.NumS = 1;
bc{1}.s(1).xpos = nx{1}/(4) + 5; %change here nx{1}/(4) + 5;
bc{1}.s(1).type = 'ss';
bc{1}.s(1).fct = @PlaneWaveBC;
% mag = -1/c_eta_0;
mag = 1;
phi = 0;
omega = f*2*pi; %CHANGE HERE
betap = 0;
t0 = 30e-15;
st = -0.05; %CHANGE 15e-15;
s = 0;
y0 = yMax/2;
sty = 1.5*lambda;
